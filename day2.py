...
# {name} liked to hum the song P{song} while coding. It was so annoying that their teammates would
...
# #in java script we would write a variable like this
# #var name = "john"
...
# print("the length of the string is" + (len(phrase)))
...
print(phrase2[5])
print(phrase2[13])
#string slicing if I wanted to get entire string or word 
print(phrase2[13:18])
print(phrase2[19:23])
print(phrase2[0:7])
print(phrase2[-1])
